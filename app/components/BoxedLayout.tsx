...
import {NavigationComponent} from "./BoxedLayoutComponents/";

interface BoxedLayoutProps {
    children?: React.ReactNode
}

export default function BoxedLayout(props: BoxedLayoutProps) {

    return (
        <>
            <div className="bg-gray-200 text-gray-800 pb-10">
                {/* Navigation starts */}
                <NavigationComponent />
                {/* Navigation ends */}
                {/* Page title starts */}
